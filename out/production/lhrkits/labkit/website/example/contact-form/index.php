		...
		<div id="affero-page">
			<header>
				<div class="affero-header">
					...
					<a href="http://210.45.66.91/example/"><img src="../rw_common/images/1ld-logo" width="155" height="100" alt="Site logo"/><h1>Affero</h1></a>
				</div>
			</header>
...
<?php unset($_SESSION['form']); ?>
		...
		<nav id="affero-menu">
			<div>
				<a class="affero-site-link" href="http://210.45.66.91/example/"><img src="../rw_common/images/1ld-logo" width="155" height="100" alt="Site logo"/><h1>Affero</h1></a>
